...
public class ${className} implements ${facadeClassName} {
     ...
     */
    @Override
    public ResponseResult<${voClassName}> get(String id) throws BizException {
        ResponseResult responseResult = new ResponseResult(ResponseCode.UNAVAILABLE);
        return responseResult;
    }
     ...
     */
    @Override
    public ResponseResult<String> update(String id, ${dtoClassName} param) throws BizException {
        ResponseResult responseResult = new ResponseResult(ResponseCode.UNAVAILABLE);
        return responseResult;
    }
     ...
     */
    @Override
    public ResponseResult<String> delete(String id) throws BizException {
        ResponseResult responseResult = new ResponseResult(ResponseCode.UNAVAILABLE);
        return responseResult;
    }
