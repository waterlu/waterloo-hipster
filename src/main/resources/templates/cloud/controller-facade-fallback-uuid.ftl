...
public class ${className} implements ${facadeClassName} {
     ...
     */
    @Override
    public ResponseData<${voClassName}> get(String id) throws BizException {
        return new ResponseData(ResponseCode.UNAVAILABLE);
    }
     ...
     */
    @Override
    public SimpleResponseData update(String id, ${dtoClassName} param) throws BizException {
     ...
     */
    @Override
    public SimpleResponseData delete(String id) throws BizException {
        return new SimpleResponseData(ResponseCode.UNAVAILABLE);
    }
